          ...
          {status === "success" ? (
            ...
            >
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-[#5a0505] to-[#800000] text-white rounded-2xl font-bold flex items-center justify-center gap-3 transition-all disabled:opacity-50 border border-white/5 shadow-xl uppercase tracking-widest text-xs active:enabled:scale-95 disabled:cursor-not-allowed"
              >
                {status === "loading" ? (
                  <>
                    <svg
